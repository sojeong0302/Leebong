...
stage_height=stage_size[1] #스테이지의 노이 위에 캐릭터를 두기 위해 사용
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_idx <3:
                    ...
                    balls.append({
                        ...
                        "img_idx": ball_img_idx +1, #공의 이미지 익덱스
                        "to_x": -3, #x축 이동방향, -3 이면 왼쪽으로, 3이면 오른쪽으로
                        "to_y": -6, #y축 이동방향,
